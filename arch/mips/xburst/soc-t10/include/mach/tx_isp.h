...
#define TX_ISP_FR_CHANNEL_MAX_HEIGHT	1024
#define TX_ISP_DS1_CHANNEL_MAX_WIDTH	640
#define TX_ISP_DS1_CHANNEL_MAX_HEIGHT	480
#if TX_ISP_EXIST_DS2_CHANNEL
#define TX_ISP_DS2_CHANNEL_MAX_WIDTH	0
#define TX_ISP_DS2_CHANNEL_MAX_HEIGHT	0
#endif
/*
