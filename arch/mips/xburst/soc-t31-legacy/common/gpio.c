...
#define PXPDRVL		0x130  /* Port DRIVE_STRNGTH Low bit Register */
#define PXPDRVLS	0x134  /* Port DRIVE_STRNGTH Low bit Set Register */
#define PXPDRVLC	0x138  /* Port DRIVE_STRNGTH Low bit Clear Register */
#define PXPDRVH		0x140  /* Port DRIVE_STRNGTH High bit Register */
#define PXPDRVHS	0x144  /* Port DRIVE_STRNGTH High bit Set Register */
#define PXPDRVHC	0x148  /* Port DRIVE_STRNGTH High bit Clear Register */
...
static void gpio_set_func(struct jzgpio_chip *chip, enum gpio_function func, unsigned int pins)
{
	unsigned long flags;
	unsigned long grp;
...
static void gpio_restore_func(struct jzgpio_chip *chip, struct gpio_reg_func *rfunc, unsigned int pins)
{
...
int jz_gpio_save_reset_func(enum gpio_port port, enum gpio_function dst_func, unsigned long pins, struct gpio_reg_func *rfunc)
{
...
int jz_gpio_restore_func(enum gpio_port port, unsigned long pins, struct gpio_reg_func *rfunc)
{
	struct jzgpio_chip *jz = &jz_gpio_chips[port];
...
static int jz_gpio_set_pull(struct gpio_chip *chip, unsigned offset, unsigned pull)
{
